...
const TabbedView = ({
	...
	return (
		<div className='TabbedView'>
			{/* THE NAV */}
			<nav className='nav'>
				<div className={labelClassName(1)} onClick={() => setView(1)}>
					{label1}
				</div>
				<div className={labelClassName(2)} onClick={() => setView(2)}>
					{label2}
				</div>
				{label3 && (
					<div className={labelClassName(3)} onClick={() => setView(3)}>
						{label3}
					</div>
				)}
				{label4 && (
					<div className={labelClassName(4)} onClick={() => setView(4)}>
						{label4}
					</div>
				)}
			</nav>
