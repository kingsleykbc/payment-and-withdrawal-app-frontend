...
const Button = ({
  label, onClick, isLoading, rounded, disabled, borderRadius, icon, hasShadow, iconPosition,
  iconColor, className, fontWeight, type, filled, color, textColor, hoverColor, width, margin,
  slideDirection, loadingText, showTextOnLoad, hPadding, vPadding, children, buttonType, fontSize
}) => {
   ...
   */
  color = color ? color
    : (buttonType === "success") ? theme.colors.successColor
    : (buttonType === "error" || buttonType === "danger") ? theme.colors.dangerColor
